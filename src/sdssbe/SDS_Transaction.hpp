...
#ifndef _SDS_TRANSACTION_HPP_
#define _SDS_TRANSACTION_HPP_
...
private:
    ...
    SDS_Transaction(const SDS_Transaction&) {}

public:

    SDS_Transaction(void) : buffer_(NULL), bufferLength_(0), offset_(0) {}

    static const sbe_uint16_t sbeBlockLength(void)
    {
        return (sbe_uint16_t)66;
    }
    ...
    SDS_Transaction &wrapForEncode(char *buffer, const int offset, const int bufferLength)
    {
        buffer_ = buffer;
        offset_ = offset;
    ...
    SDS_Transaction &wrapForDecode(char *buffer, const int offset, const int actingBlockLength, const int actingVersion,
    ...
    SDS_Transaction &seqno(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &putCode(const char *src)
    {
    ...
    SDS_Transaction &date(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &time(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &sDSTime(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &sn(const sbe_uint32_t value)
    {
    ...
    static const sbe_uint32_t indexNullValue()
    {
        return 4294967294;
    }

    static const sbe_uint32_t indexMinValue()
    {
        return 0;
    }

    static const sbe_uint32_t indexMaxValue()
    {
        return 4294967293;
    }

    sbe_uint32_t index(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_uint32_t *)(buffer_ + offset_ + 36)));
    }

    SDS_Transaction &index(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &price(const sbe_uint32_t value)
    {
    ...
    SDS_Transaction &volume(const sbe_uint32_t value)
    {
    ...
    static const sbe_uint32_t turnoverNullValue()
    {
        return 4294967294;
    }

    static const sbe_uint32_t turnoverMinValue()
    {
        return 0;
    }

    static const sbe_uint32_t turnoverMaxValue()
    {
        return 4294967293;
    }

    sbe_uint32_t turnover(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_uint32_t *)(buffer_ + offset_ + 48)));
    }

    SDS_Transaction &turnover(const sbe_uint32_t value)
    {
        *((sbe_uint32_t *)(buffer_ + offset_ + 48)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }

    static const int bSFlagId(void)
    {
        return 11;
    }

    static const int bSFlagSinceVersion(void)
    {
         return 0;
    }

    bool bSFlagInActingVersion(void)
    {
        return (actingVersion_ >= 0) ? true : false;
    }


    static const char *BSFlagMetaAttribute(const MetaAttribute::Attribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute::EPOCH: return "unix";
    ...
    static const sbe_char_t bSFlagNullValue()
    {
        return (sbe_char_t)0;
    }

    static const sbe_char_t bSFlagMinValue()
    {
        return (sbe_char_t)32;
    }

    static const sbe_char_t bSFlagMaxValue()
    {
        return (sbe_char_t)126;
    }

    sbe_char_t bSFlag(void) const
    {
        return (*((sbe_char_t *)(buffer_ + offset_ + 52)));
    }

    SDS_Transaction &bSFlag(const sbe_char_t value)
    {
        *((sbe_char_t *)(buffer_ + offset_ + 52)) = (value);
        return *this;
    }
    ...
    {
        return (*((sbe_char_t *)(buffer_ + offset_ + 53)));
    }

    SDS_Transaction &orderKind(const sbe_char_t value)
    {
        *((sbe_char_t *)(buffer_ + offset_ + 53)) = (value);
        return *this;
    }
    ...
    static const sbe_uint32_t functionCodeNullValue()
    {
        return 4294967294;
    }

    static const sbe_uint32_t functionCodeMinValue()
    {
        return 0;
    }

    static const sbe_uint32_t functionCodeMaxValue()
    {
        return 4294967293;
    }

    sbe_uint32_t functionCode(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_uint32_t *)(buffer_ + offset_ + 54)));
    }

    SDS_Transaction &functionCode(const sbe_uint32_t value)
    {
        *((sbe_uint32_t *)(buffer_ + offset_ + 54)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }

    static const int askOrderId(void)
    {
        return 14;
    }

    static const int askOrderSinceVersion(void)
    {
         return 0;
    }

    bool askOrderInActingVersion(void)
    {
        return (actingVersion_ >= 0) ? true : false;
    }


    static const char *AskOrderMetaAttribute(const MetaAttribute::Attribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute::EPOCH: return "unix";
    ...
    static const sbe_uint32_t askOrderNullValue()
    {
        return 4294967294;
    }

    static const sbe_uint32_t askOrderMinValue()
    {
        return 0;
    }

    static const sbe_uint32_t askOrderMaxValue()
    {
        return 4294967293;
    }

    sbe_uint32_t askOrder(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_uint32_t *)(buffer_ + offset_ + 58)));
    }

    SDS_Transaction &askOrder(const sbe_uint32_t value)
    {
        *((sbe_uint32_t *)(buffer_ + offset_ + 58)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }

    static const int bidOrderId(void)
    {
        return 15;
    }

    static const int bidOrderSinceVersion(void)
    {
         return 0;
    }

    bool bidOrderInActingVersion(void)
    {
        return (actingVersion_ >= 0) ? true : false;
    }


    static const char *BidOrderMetaAttribute(const MetaAttribute::Attribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute::EPOCH: return "unix";
    ...
    static const sbe_uint32_t bidOrderNullValue()
    {
        return 4294967294;
    }

    static const sbe_uint32_t bidOrderMinValue()
    {
        return 0;
    }

    static const sbe_uint32_t bidOrderMaxValue()
    {
        return 4294967293;
    }

    sbe_uint32_t bidOrder(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_uint32_t *)(buffer_ + offset_ + 62)));
    }

    SDS_Transaction &bidOrder(const sbe_uint32_t value)
    {
        *((sbe_uint32_t *)(buffer_ + offset_ + 62)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }
};
}
