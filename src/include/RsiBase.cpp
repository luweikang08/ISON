...
RSI_STORE_RetCode RsiBase::Store(std::string kline_src)
{
...
void RsiBase::GetResult(double Result[])
{
...
std::string RsiBase::MakeSendStr(int topic, int sn)
{
...
const char* RsiBase::GetDataCode()const
{
	if (SendStr.size() > 0)
	{
